...
The Phase 2 target architecture is approved. It is a design target, not an implemented-state claim. The current application remains the monolithic implementation described in [`CURRENT_STATE.md`](CURRENT_STATE.md).
