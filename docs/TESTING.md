...
The current Domain baseline was measured on 2026-08-23 after the Phase 4 WP8 Auth return-target slice over the active `src/domain/**/*.ts` scope: Statements 100% (168/168), Branches 99.24% (131/132), Functions 100% (39/39), and Lines 100% (144/144). The suite completed 13 files and 68 tests. This is a Domain-only baseline, not a repository-wide quality claim, and it does not cover the frozen legacy application or future Product integration. No numeric threshold or ratchet is configured yet; setting one requires separate approval.
