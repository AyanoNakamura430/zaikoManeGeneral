...
The current Domain baseline was measured on 2026-08-22 after the Phase 4 WP5 Search-field assembly slice over the active `src/domain/**/*.ts` scope: Statements 100% (124/124), Branches 99% (99/100), Functions 100% (30/30), and Lines 100% (107/107). The suite completed 10 files and 48 tests. This is a Domain-only baseline, not a repository-wide quality claim, and it does not cover the frozen legacy application or future Product integration. No numeric threshold or ratchet is configured yet; setting one requires separate approval.
