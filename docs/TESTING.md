...
The current Domain baseline was measured on 2026-08-22 after the Phase 4 WP6 Category-policy slice over the active `src/domain/**/*.ts` scope: Statements 100% (137/137), Branches 99.1% (111/112), Functions 100% (32/32), and Lines 100% (118/118). The suite completed 11 files and 54 tests. This is a Domain-only baseline, not a repository-wide quality claim, and it does not cover the frozen legacy application or future Product integration. No numeric threshold or ratchet is configured yet; setting one requires separate approval.
